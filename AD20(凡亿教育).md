...
## AD铺铜总是和其他元器件距离太近
在画座椅风扇的PCB的时候，铺铜之后的离其他器件的距离都很近，出了过孔，后来发现是我之前为了让过孔自动盖油，添加了ISVIA这个规则，并且没有新建规则，而是在原有规则上改的，可能是这个导致过孔的优先级最高，导致只有过孔的规则有效，其他的规则貌似都无效了

## 怎样对丝印文字反色输出并进行位置调整

![image-20250916112112551](assets/image-20250916112112551.png)

在丝印属性中选择TrueType--->勾选Inverted,在下面调整大小，在上面调整位置

> [怎样对丝印文字反色输出及位置进行设置可以变成图片的样子？？？ - Altium Protel论坛 - EDA365电子论坛网](https://eda365.com/thread-216430-1-1.html)
>
> ![img](assets/forum.png)
>
> ![img](assets/forum-1757993012349-3.png)
